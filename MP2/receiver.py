...
#host and port to match sender
HOST = "localhost"
PORT = 1234
#globals
PACKET_HEADER = "!IIHH" #same packet layout as sender
MAX_PAYLOAD = 1024
FLAG_SYN = 0x1
FLAG_ACK = 0x2
FLAG_FIN = 0x4
...
class PRTPReceiver:
    ...
    def start(self):
        ...
        while True:
            ...
            ack_pkt = make_packet(0, self.expected_seq, FLAG_ACK, self.window)
            self.sock.sendto(ack_pkt, addr)
            print(f"[Receiver] Sent ACK for seq={self.expected_seq-1}")
